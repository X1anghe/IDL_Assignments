...
def multi_classficationBeta(x_train, y_train, x_test, y_test, batch_size, epochs, lr, num_classes, input_shape):
    ...
    # Multiclass
    output_class = Dense(num_classes, activation='softmax', name='hours')(drop4)
    # Regression
